                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            noValidate
                            className={`w-full px-5 py-4 bg-gray-50 dark:bg-gray-800 border-2 ${combinedErrors.email ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-transparent'
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onChange={handleChange}
                                noValidate
                                className={`w-full px-5 py-4 bg-gray-50 dark:bg-gray-800 border-2 ${combinedErrors.password ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-transparent'
                                    } rounded-2xl focus:bg-white dark:focus:bg-gray-900 focus:outline-none focus:border-orange-500 transition-all dark:text-white font-medium shadow-inner shadow-gray-200 dark:shadow-none`}
                                placeholder="••••••••"
                            />
                            <button
