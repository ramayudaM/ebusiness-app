                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                noValidate
                                className={`w-full pl-10 pr-4 py-2 bg-gray-100 dark:bg-gray-800 border-2 ${combinedErrors.name ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-transparent'
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                noValidate
                                className={`w-full pl-10 pr-4 py-2 bg-gray-100 border-2 ${combinedErrors.email ? 'border-red-500 bg-red-50' : 'border-transparent'
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                noValidate
                                className={`w-full pl-10 pr-10 py-2 bg-gray-100 dark:bg-gray-800 border-2 ${combinedErrors.password ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-transparent'
                                    } rounded-xl focus:bg-white dark:focus:bg-gray-900 dark:text-white focus:outline-none focus:border-orange-500 transition-all`}
                                placeholder="••••••••"
                            />
                            <button
                        ...
                        <div className="flex gap-1 mt-2">
                            <div
                                className={`h-1 flex-1 rounded-full transition-all duration-500 ${passwordStrength.score >= 1 ? passwordStrength.color : 'bg-gray-200'
                                    }`}
                            ></div>
                            <div
                                className={`h-1 flex-1 rounded-full transition-all duration-500 ${passwordStrength.score >= 3 ? passwordStrength.color : 'bg-gray-200'
                                    }`}
                            ></div>
                            <div
                                className={`h-1 flex-1 rounded-full transition-all duration-500 ${passwordStrength.score >= 5 ? passwordStrength.color : 'bg-gray-200'
                                    }`}
                            ></div>
                        </div>
