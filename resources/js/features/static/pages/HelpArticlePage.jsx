...
export const HelpArticlePage = () => {
    ...
    const articles = {
            ...
            content: (
                <div className="space-y-6 text-zinc-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-zinc-900/40 p-6 rounded-2xl border border-zinc-800/80 backdrop-blur-sm transition-colors">
                            <h4 className="font-bold text-white mb-3 flex items-center gap-2"><Clock size={18} className="text-orange-500" /> Estimasi Waktu</h4>
                            <p className="text-sm text-zinc-400">Proses packing kayu standar studio kami memakan waktu 24 jam untuk memastikan keamanan maksimal sebelum dikirim.</p>
                        </div>
                        <div className="bg-zinc-900/40 p-6 rounded-2xl border border-zinc-800/80 backdrop-blur-sm transition-colors">
                            <h4 className="font-bold text-white mb-3 flex items-center gap-2"><ShieldCheck size={18} className="text-orange-500" /> Proteksi Ganda</h4>
                            <p className="text-sm text-zinc-400">Setiap gitar dan keyboard wajib menggunakan Hardcase atau Box Kayu tambahan untuk pengiriman luar kota.</p>
                        </div>
                    </div>
                </div>
            )
            ...
            content: (
                <div className="space-y-6 text-zinc-300">
                    ...
                    <ul className="space-y-4">
                        <li className="flex gap-4 p-4 bg-zinc-900/40 border border-zinc-800/80 rounded-xl transition-colors">
                            <div className="font-bold text-orange-500">01.</div>
                            <div>
                                <h5 className="font-bold text-white">Virtual Account & Bank Transfer</h5>
                                <p className="text-sm text-zinc-400">Verifikasi otomatis untuk BCA, Mandiri, BNI, dan BRI.</p>
                            </div>
                        </li>
                        <li className="flex gap-4 p-4 bg-zinc-900/40 border border-zinc-800/80 rounded-xl transition-colors">
                            <div className="font-bold text-orange-500">02.</div>
                            <div>
                                <h4 className="font-bold text-white">Cicilan 0%</h4>
                                <p className="text-sm text-zinc-400">Nikmati cicilan 0% hingga 12 bulan menggunakan kartu kredit atau partner pembiayaan kami.</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        'pengembalian': {
            ...
            content: (
                <div className="space-y-6 text-zinc-300">
                    ...
                    <div className="bg-orange-950/20 p-6 rounded-2xl border border-orange-900/40 text-orange-400 transition-colors">
                        <h4 className="font-bold text-orange-450 mb-3 flex items-center gap-2"><CircleAlert size={18} /> Aturan Emas Retur</h4>
                        <p className="text-sm text-orange-200/90">Wajib melampirkan video unboxing tanpa terputus. Tanpa video ini, mohon maaf klaim tidak dapat diproses.</p>
                    </div>
                </div>
            )
        },
        ...
        'lacak-pesanan': {
            ...
            content: (
                <div className="space-y-6 text-zinc-300">
                    ...
                    <div className="bg-blue-950/20 p-6 rounded-2xl border border-blue-900/40 flex gap-4 text-blue-400 transition-colors">
                        <Info className="text-blue-400 shrink-0" size={24} />
                        <p className="text-sm text-blue-200 leading-relaxed">Pembaruan status pengiriman biasanya memakan waktu 1x24 jam setelah kurir menjemput paket dari studio kami.</p>
                    </div>
                </div>
            )
        },
        ...
        'garansi-pengiriman': {
            ...
            content: (
                <div className="space-y-6 text-zinc-300">
                    <p className="text-white">Semua instrumen yang dibeli di NadaKita sudah termasuk <strong>Asuransi Pengiriman Penuh</strong> secara gratis.</p>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="p-4 bg-zinc-900/40 rounded-xl border border-zinc-800/80 transition-colors">
                            <h4 className="font-bold text-white mb-2">Apa yang Dicover?</h4>
                        ...
                        <div className="p-4 bg-zinc-900/40 rounded-xl border border-zinc-800/80 transition-colors">
                            <h4 className="font-bold text-white mb-2">Syarat Klaim</h4>
                            <ul className="text-sm space-y-1 text-zinc-400">
            ...
            content: (
                <div className="space-y-6 text-zinc-300">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 border border-zinc-800/80 bg-zinc-900/40 rounded-xl transition-colors">
                            <h4 className="font-bold text-white">Virtual Account</h4>
                            <p className="text-sm text-zinc-400">BCA, Mandiri, BNI, BRI, Permata. Verifikasi otomatis.</p>
                        </div>
                        <div className="p-4 border border-zinc-800/80 bg-zinc-900/40 rounded-xl transition-colors">
                            <h4 className="font-bold text-white">E-Wallet</h4>
                            <p className="text-sm text-zinc-400">GoPay, OVO, ShopeePay, Dana, LinkAja.</p>
                        </div>
                        <div className="p-4 border border-zinc-800/80 bg-zinc-900/40 rounded-xl transition-colors">
                            <h4 className="font-bold text-white">Kartu Kredit & Cicilan</h4>
                            <p className="text-sm text-zinc-400">Visa, Mastercard, JCB, AMEX. Cicilan 0% hingga 12 bulan.</p>
                        </div>
                    </div>
                </div>
            )
        ...
        'klaim-garansi': {
            ...
            content: (
                <div className="space-y-6 text-zinc-300">
                    ...
                    <div className="bg-blue-950/20 border border-blue-900/40 p-6 rounded-2xl text-blue-400 transition-colors">
                        <h4 className="font-bold text-blue-300 mb-2">Cara Klaim:</h4>
                        <p className="text-sm text-blue-200">Cukup bawa unit Anda beserta invoice pembelian dan kartu garansi ke Service Center mitra kami atau kirimkan kembali ke Studio NadaKita.</p>
                    </div>
                </div>
            )
        },
        ...
        'verifikasi-akun': {
            ...
            content: (
                <div className="space-y-6 text-zinc-300">
                    ...
                    <div className="p-4 border border-blue-900/40 rounded-xl bg-blue-950/20 text-sm text-blue-300">
                ...
                <div className="space-y-8 text-zinc-300">
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            <div key={i} className="border-b border-zinc-800/60 pb-6 transition-colors">
                                <h4 className="font-bold text-white mb-2">Q: {item.q}</h4>
                                <p className="text-zinc-400 text-sm leading-relaxed">A: {item.a}</p>
                            </div>
                        ))}
                    </div>
                </div>
    ...
    const article = articles[slug] || {
        ...
        icon: <CircleAlert className="text-zinc-500" />,
        content: (
            <div className="text-center py-20">
                <p className="text-zinc-500">Mohon maaf, artikel bantuan yang Anda cari belum tersedia atau sedang dalam pembaruan.</p>
                <Link to="/help" className="mt-6 inline-block text-orange-500 font-bold hover:underline">Kembali ke Pusat Bantuan</Link>
            </div>
        )
    };
    ...
    return (
        <Layout>
            <div className="bg-[#050505] border-b border-zinc-900 transition-colors">
                <div className="max-w-4xl mx-auto px-4 md:px-8 py-4">
                    <Link to="/help" className="inline-flex items-center gap-2 text-sm text-zinc-500 hover:text-orange-500 transition-colors font-medium">
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-8 py-16">
                <header className="mb-12">
                    <div className="w-16 h-16 bg-zinc-900/40 border border-zinc-800/80 rounded-2xl flex items-center justify-center mb-6 text-3xl transition-colors">
                        {article.icon}
                    </div>
                    <h1 className="text-3xl md:text-4xl font-black text-white tracking-tight mb-4 transition-colors">
                        {article.title}
                    </h1>
                ...
                <div className="prose prose-invert max-w-none text-zinc-300 leading-relaxed transition-colors">
                    {article.content}
                </div>
            </div>
        </Layout>
