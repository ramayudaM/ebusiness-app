          ...
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-2">
              ...
              >
                ...
                <path
                  d="M15 12 L15 28 M20 10 L20 30 M25 14 L25 26"
                  stroke="white"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl text-orange-100 mb-8 leading-relaxed">
                Temukan instrumen musik berkualitas tinggi dari brand ternama dunia. Mulai
                perjalanan musikmu bersama NadaKita.
              </p>
          ...
          {[
            {
              ...
              rating: 4.9,
              image: 'https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?w=500&q=80',
            },
            {
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-700 mb-4 italic">
              "Pelayanan sangat memuaskan! Gitar yang saya beli original dan kualitasnya luar biasa.
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-700 mb-4 italic">
              "Harga kompetitif dan banyak pilihan. Customer service responsif bantu saya pilih
              keyboard yang tepat."
            </p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center text-orange-600 font-bold">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-700 mb-4 italic">
              "Sudah langganan di NadaKita sejak 2 tahun lalu. Selalu puas dengan produk dan
              layanannya!"
            </p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center text-orange-600 font-bold">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-4 leading-relaxed">
                NadaKita adalah platform e-commerce terpercaya untuk instrumen musik di Indonesia.
                Kami menyediakan berbagai pilihan instrumen berkualitas dari brand ternama dunia.
              </p>
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                Dengan pengalaman lebih dari 5 tahun, kami telah melayani ribuan musisi dan pecinta
        ...
        <div className="space-y-4">
          <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 mt-4">
              Ya, semua produk di NadaKita 100% original dan berasal dari distributor resmi. Kami
              memberikan garansi resmi untuk setiap produk.
            </p>
          </details>
          <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <summary className="font-semibold text-gray-900 cursor-pointer flex items-center justify-between">
            ...
            <p className="text-gray-600 mt-4">
              Kami menerima berbagai metode pembayaran: Transfer Bank, Kartu Kredit/Debit, E-wallet
          ...
          <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 mt-4">
              Pengiriman dalam kota 1-2 hari kerja, luar kota 3-5 hari kerja. Kami menggunakan jasa
              ekspedisi terpercaya dengan tracking number.
            </p>
          </details>
          <details className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <summary className="font-semibold text-gray-900 cursor-pointer flex items-center justify-between">
            ...
            <p className="text-gray-600 mt-4">
              Semua produk dilengkapi dengan garansi resmi dari distributor. Masa garansi bervariasi
              tergantung brand dan jenis produk.
            </p>
          </details>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-gray-300 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <div className="flex gap-3">
                <a
                  href="https://instagram.com/nadakita"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-800 rounded-full hover:bg-orange-500 transition flex items-center justify-center group"
                >
                  <svg
                    className="w-5 h-5 fill-gray-300 group-hover:fill-white transition"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <a
                  href="https://tiktok.com/@nadakita"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-800 rounded-full hover:bg-orange-500 transition flex items-center justify-center group"
                >
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">© 2026 NadaKita. All rights reserved.</p>
