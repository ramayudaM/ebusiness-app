        ...
        <Layout>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                <input 
                                    ...
                                    className="w-full bg-gray-50 border border-gray-200 rounded-lg pl-9 pr-3 py-2 text-sm focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all"
                                />
                            ...
                            {isLoadingCategories ? (
                                ...
                                <div className="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                                    <label className="flex items-center gap-3 cursor-pointer group">
                                        ...
                                        />
                                        <span className={`text-sm ${filters.category === '' ? 'text-orange-600 font-bold' : 'text-gray-600 group-hover:text-gray-900'}`}>
                                            Semua Kategori
                                        </span>
                                    </label>
                                    {categories.map((cat) => (
                                        <label key={cat.id} className="flex items-center gap-3 cursor-pointer group">
                                            <input 
                                                ...
                                                className="w-4 h-4 text-orange-600 focus:ring-orange-500"
                                            />
                                            <span className={`text-sm flex-1 ${filters.category === cat.slug ? 'text-orange-600 font-bold' : 'text-gray-600 group-hover:text-gray-900'}`}>
                                                {cat.name}
                                            </span>
                ...
                <div className="flex-1 w-full flex flex-col">
                    ...
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                        ...
                        <div className="flex items-center gap-3">
                            <button 
                                ...
                                className="lg:hidden flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 text-sm font-bold rounded-lg transition-colors border border-gray-200"
                            >
                            ...
                            <div className="relative shrink-0">
                                <select 
                                    ...
                                    className="appearance-none bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-lg pl-4 pr-10 py-2.5 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none cursor-pointer"
                                >
                    ...
                    <div className="flex-1">
                        {isLoadingProducts ? (
                            ...
                            <div className="py-20 text-center flex flex-col items-center bg-white rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    {!isLoadingProducts && meta?.last_page > 1 && (
                        <div className="mt-10 flex items-center justify-center gap-2">
                            <button 
                                ...
                                className="px-4 py-2 border border-gray-200 bg-white text-sm font-bold text-gray-700 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Prev
                            </button>
            ...
            {isMobileFilterOpen && (
                <div className="fixed inset-0 z-[60] lg:hidden flex justify-end">
                    ...
                    ></div>
                    <div className="relative w-[85%] max-w-sm bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right">
                        <div className="flex items-center justify-between p-5 border-b border-gray-100 bg-gray-50">
                            ...
                            <button 
                                onClick={() => setIsMobileFilterOpen(false)}
                                className="w-8 h-8 flex items-center justify-center rounded-full bg-white border border-gray-200 text-gray-500 hover:text-gray-900 shadow-sm"
                            >
                                <X size={18} />
                            </button>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-5 custom-scrollbar">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input 
                                            ...
                                            value={localSearch}
                                            onChange={handleSearchChange}
                                            className="w-full bg-gray-50 border border-gray-200 rounded-lg pl-9 pr-3 py-3 text-sm focus:ring-2 focus:border-orange-500 outline-none"
                                        />
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        <label className="flex items-center gap-3 cursor-pointer">
                                            ...
                                            />
                                            <span className={`text-base ${filters.category === '' ? 'text-orange-600 font-bold' : 'text-gray-700'}`}>
                                                Semua Kategori
                                            </span>
                                        </label>
                                        {categories.map((cat) => (
                                            <label key={cat.id} className="flex items-center gap-3 cursor-pointer">
                                                <input 
                                                    ...
                                                    className="w-5 h-5 text-orange-600 focus:ring-orange-500"
                                                />
                                                <span className={`text-base flex-1 ${filters.category === cat.slug ? 'text-orange-600 font-bold' : 'text-gray-700'}`}>
                                                    {cat.name}
                                                </span>
                                            </label>
                                        ))}
                                ...
                                {/* Stock */}
                                <label className="flex items-center gap-3 cursor-pointer bg-gray-50 p-3 rounded-lg border border-gray-200">
                                    <div className="relative flex items-center">
                                        <input 
                                            type="checkbox" 
                                            checked={filters.in_stock}
                                            onChange={(e) => setFilter('in_stock', e.target.checked)}
                                            className="w-6 h-6 appearance-none border-2 border-gray-300 rounded focus:ring-orange-500 checked:bg-orange-600 checked:border-orange-600"
                                        />
                        ...
                        <div className="p-5 border-t border-gray-100 flex gap-3 bg-white">
                            <button 
                                onClick={resetFilters}
                                className="px-4 py-3 flex-1 bg-red-50 text-red-600 font-bold rounded-xl active:scale-95 transition-transform"
                            >
                                Reset
                            </button>
                            <button 
                                onClick={() => setIsMobileFilterOpen(false)}
                                className="px-4 py-3 flex-[2] bg-orange-600 text-white font-bold rounded-xl shadow-md shadow-orange-500/20 active:scale-95 transition-transform"
                            >
                                Terapkan Filter
                            </button>
                        </div>
