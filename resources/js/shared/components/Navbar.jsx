                    ...
                    <div className="hidden lg:flex items-center gap-6 shrink-0">
                        {navLinks.map((link) => (
                            <Link
                                key={link.name}
                                to={link.path}
                                className={`text-sm font-medium transition-colors ${location.pathname === link.path ? 'text-gray-900 font-bold' : 'text-gray-600 hover:text-gray-900'
                                    }`}
                            >
                                {link.name}
                            </Link>
                        ...
                        <form onSubmit={handleSearch} className="relative w-full">
                            <div className="relative group w-full">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-12 pr-4 py-2.5 bg-gray-50 dark:bg-gray-900 border-none rounded-xl text-sm focus:ring-2 focus:ring-orange-500/20 placeholder-gray-400 dark:placeholder-gray-500 dark:text-white transition-all shadow-inner ${searchError ? 'ring-2 ring-red-500' : ''
                                        }`}
                                />
                            </div>
                            {searchError && (
                                                        ...
                                                        {notifications.map((n) => (
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex gap-3">
                                                                    <div className={`w-10 h-10 rounded-xl shrink-0 flex items-center justify-center ${n.type === 'promo' ? 'bg-purple-100 text-purple-600' : 'bg-blue-100 text-blue-600'
                                                                        }`}>
                            ...
                            <div className="p-5 border-b border-gray-100 dark:border-gray-800 transition-colors">
                                <form onSubmit={handleSearch} className="relative w-full">
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-gray-100 dark:bg-gray-800 border-none rounded-full py-3 pl-10 pr-4 text-sm outline-none focus:ring-2 focus:ring-orange-500/20 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all ${searchError ? 'ring-2 ring-red-500/50' : ''
                                            }`}
                                    />
                                    {searchError && (
